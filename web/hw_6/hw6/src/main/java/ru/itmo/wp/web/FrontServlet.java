...
public class FrontServlet extends HttpServlet {
    ...
    private Method getMethod(Class<?> pageClass, String methodStr) throws NotFoundException {
        Method method = null;
        for (Class<?> clazz = pageClass; method == null && clazz != null; clazz = clazz.getSuperclass()) {
            try {
                method = clazz.getDeclaredMethod(methodStr, HttpServletRequest.class, Map.class);
